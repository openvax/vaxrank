...
class EpitopePrediction(DataclassSerializable):
    ...
    # numeric values are in [0, 1]. Per-position cleavage probability
    # at the C-terminus of this peptide (probability the proteasome
    # cuts between this peptide's last residue and its C+1 flank);
    # higher = clean release.
    ...
    # reaching MHC.
    max_internal_cut_prob: Optional[float] = None
