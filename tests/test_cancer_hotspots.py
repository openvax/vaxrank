...
class TestDataLoading:
    """Tests for loading the cancer hotspots data file"""

    def test_hotspots_path_exists(self):
    ...
    def test_hotspot_entry_structure(self):
...
class TestKnownHotspots:
    """Tests for known cancer hotspots"""

    def test_braf_v600e_is_hotspot(self):
        """Test that BRAF V600E is recognized as a hotspot"""
        ok_(is_hotspot("BRAF", "V600E"))

    def test_braf_v600e_with_p_prefix(self):
        """Test that p.V600E notation works"""
        ok_(is_hotspot("BRAF", "p.V600E"))

    def test_tp53_hotspots(self):
...
class TestCaseInsensitivity:
    ...
    def test_gene_lowercase(self):
        """Test that lowercase gene names work"""
        ok_(is_hotspot("braf", "V600E"))

    def test_gene_mixed_case(self):
        """Test that mixed case gene names work"""
        ok_(is_hotspot("Braf", "V600E"))

    def test_protein_change_lowercase(self):
...
class TestNonHotspots:
    """Tests for mutations that are NOT hotspots"""

    def test_random_mutation_not_hotspot(self):
        """Test that a random mutation is not a hotspot"""
        ok_(not is_hotspot("FAKEGENE", "X999Y"))

    def test_real_gene_fake_mutation(self):
...
class TestGetHotspotInfo:
    """Tests for get_hotspot_info function"""

    def test_returns_dict_for_hotspot(self):
...
class TestGetHotspotUrl:
    """Tests for get_hotspot_url function"""

    def test_returns_url_for_hotspot(self):
        """Test that URL is returned for known hotspot"""
    ...
    def test_url_contains_gene(self):
        """Test that URL contains gene name"""
        url = get_hotspot_url("BRAF", "V600E")
        ok_("BRAF" in url)

    def test_url_points_to_cancerhotspots(self):
